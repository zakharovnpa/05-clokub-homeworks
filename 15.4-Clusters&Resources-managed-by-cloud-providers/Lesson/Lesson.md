## Ход выполнения ДЗ по теме 15.4 "Кластеры. Ресурсы под управлением облачных провайдеров"
...
- Создать группу узлов состояющую из 3 машин с автомасштабированием до 6. > Пояснение. Тут ошибка. Яндекс не дает расширяться до 6
